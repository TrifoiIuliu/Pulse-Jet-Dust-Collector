...
// Setare LCD la adresa 0x27, 16 caractere pe linie si 2 linii
...
//Afisare informatii din modul setare pe display
  setupModeDisplay();
...
actionareIesiri();
 ...
 //Trecere in modul normal de lucru
  if(setupCount>=2)
  setupBtn.resetCount();
...
//Afisare pe display la x ms informatiile ce urmeaza a fi setate
currentDisplay=millis();
 if(currentDisplay-lastDisplay>100)
 {
//Afisare timp pauza ciclu 
